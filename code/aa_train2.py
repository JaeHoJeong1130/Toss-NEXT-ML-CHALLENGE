...
# ✨ --- DeepFM 모델 업그레이드: 수치형 피처를 받도록 수정 --- ✨
...
def main():
    ...
    # --- 2. DeepFM 튜닝 및 최종 학습 ---
    cat_features_for_deepfm = ['gender', 'age_group', 'inventory_id', 'day_of_week', 'hour']
    cat_features_for_deepfm += ['gender_age_interaction', 'age_inventory_interaction']
    ...
    field_dims = [int(train_df[col].max()) + 1 for col in cat_features_for_deepfm]
